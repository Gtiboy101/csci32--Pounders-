  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-emerald-50 to-teal-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <main>
          {/* Main content area - could add welcome content here if needed */}
          {!showAuth && (
            <div className="text-center text-gray-700">
              <h2 className="text-xl mb-4">Ready to get started?</h2>
              <p className="mb-6">Click the Account button above to sign in or create an account.</p>
            </div>
          )}
        </main>
      </div>
